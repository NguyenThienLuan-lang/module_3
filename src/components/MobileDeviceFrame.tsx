...
export const MobileDeviceFrame: React.FC<MobileDeviceFrameProps> = ({
  ...
  if (deviceMode === 'desktop') {
    return (
      <div className="min-h-screen bg-[#fdfbf7] flex flex-col selection:bg-[#7d9d85]/30">
  ...
  return (
    <div className="min-h-screen bg-[#2d2824] text-[#4a453e] flex flex-col items-center justify-start md:py-6 selection:bg-[#7d9d85]/30">
      ...
      {/* Main Container */}
      {deviceMode === 'mobile_frame' ? (
        /* iPhone 16 Pro Realistic Frame on Desktop */
        <div className="relative w-full max-w-[430px] md:h-[900px] md:max-h-[92vh] md:rounded-[52px] bg-[#fdfbf7] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] md:border-[10px] md:border-[#38332d] md:ring-4 md:ring-[#524b42]/40 overflow-hidden flex flex-col">
          {/* Hardware buttons */}
          ...
          {/* Screen Content */}
          <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col relative scrollbar-none">
            {children}
          </div>
        </div>
      ) : (
        /* Full Width Centered Mobile View */
        <div className="w-full max-w-md min-h-screen bg-[#fdfbf7] shadow-2xl flex flex-col relative">
          {children}
        </div>
      )}
    </div>
